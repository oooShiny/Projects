...
def htmlconvert(finaldata):
	...
	for i in finaldata:
		if type(i.gamestatus) is datetime:
			htmldata.append("<td><table><tr><td><div class = 'info'><table><tr><td>%s</td><td>%s</td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;%s</td></tr><tr><td width=100px;>%s</td><td>%s</td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;%s</td></tr></table></div></td></tr></table></td>" % (i.hometeam, i.homescore, i.gamedate, i.awayteam, i.awayscore, i.gamestatus.strftime("%I:%M %p")))
		else: 
			htmldata.append("<td><table><tr><td><div class = 'info'><table><tr><td>%s</td><td>%s</td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;%s</td></tr><tr><td width=100px;>%s</td><td>%s</td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;%s</td></tr></table></div></td></tr></table></td>" % (i.hometeam, i.homescore, i.gamedate, i.awayteam, i.awayscore, i.gamestatus))
